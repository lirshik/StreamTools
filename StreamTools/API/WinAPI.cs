...
namespace StreamTools
{
    static class WinAPI
    {
        ...
        [DllImport("winmm.dll")]
        public static extern int waveInOpen(out IntPtr hWaveIn, int uDeviceID, WaveFormat lpFormat, IntPtr dwCallback, IntPtr dwInstance, int dwFlags);
        ...
        [DllImport("winmm.dll")]
        public static extern int waveInPrepareHeader(IntPtr hWaveIn, ref WaveHeader lpWaveHdr, int uSize);

        [DllImport("winmm.dll")]
        public static extern int waveInUnprepareHeader(IntPtr hWaveIn, ref WaveHeader lpWaveHdr, int uSize);

        [DllImport("winmm.dll")]
        public static extern int waveInAddBuffer(IntPtr hWaveIn, ref WaveHeader lpWaveHdr, int uSize);
